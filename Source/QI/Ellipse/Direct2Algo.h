...
protected:
    virtual Eigen::ArrayXd apply_internal(const Eigen::ArrayXcf &input, const double TR, const Eigen::ArrayXd &phi, const bool debug, float &residual) const override;
public:
    Direct2Algo(std::shared_ptr<QI::SSFPEcho> &seq, bool debug) : EllipseAlgo(seq, debug) {};
